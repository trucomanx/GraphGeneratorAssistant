...
from graph_generator_assistant.about import (
    __version__,
    __package__,
    __program_name__,
    __author__,
...
[tool.setuptools]
packages = ["{__package__}", "{__package__}.modules", "{__package__}.templates"]

[tool.setuptools.package-data]
"{__package__}" = ["icons/*.png", "images/*.png", "templates/*.png", "templates/*.json"]
"""
